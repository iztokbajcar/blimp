...
class DemoWindow : public Window {
    public:
        ...
        void init() {
            ...
            regPoly3Tex = new Mesh(new RegularPolygon(3, 0.9, &white), mat1);
            regPoly4Tex = new Mesh(new RegularPolygon(4, 0.9, &white), mat1);
            regPoly5Tex = new Mesh(new RegularPolygon(5, 0.9, &white), mat1);
            regPoly6Tex = new Mesh(new RegularPolygon(6, 0.9, &white), mat1);
            regPoly7Tex = new Mesh(new RegularPolygon(7, 0.9, &white), mat1);
            regPoly8Tex = new Mesh(new RegularPolygon(8, 0.9, &white), mat1);
            regPrism3Tex = new Mesh(new RegularPrism(3, 0.9, 0.9, &white), mat1);
            regPrism4Tex = new Mesh(new RegularPrism(4, 0.9, 0.9, &white), mat1);
            regPrism5Tex = new Mesh(new RegularPrism(5, 0.9, 0.9, &white), mat1);
            regPrism6Tex = new Mesh(new RegularPrism(6, 0.9, 0.9, &white), mat1);
            regPrism7Tex = new Mesh(new RegularPrism(7, 0.9, 0.9, &white), mat1);
            regPrism8Tex = new Mesh(new RegularPrism(8, 0.9, 0.9, &white), mat1);
            regPyramid3Tex = new Mesh(new RegularPyramid(3, 0.9, 0.9, &white), mat1);
            regPyramid4Tex = new Mesh(new RegularPyramid(4, 0.9, 0.9, &white), mat1);
            regPyramid5Tex = new Mesh(new RegularPyramid(5, 0.9, 0.9, &white), mat1);
            regPyramid6Tex = new Mesh(new RegularPyramid(6, 0.9, 0.9, &white), mat1);
            regPyramid7Tex = new Mesh(new RegularPyramid(7, 0.9, 0.9, &white), mat1);
            regPyramid8Tex = new Mesh(new RegularPyramid(8, 0.9, 0.9, &white), mat1);
            ...
            regPoly3Tex -> setTexture(blimp);
            regPoly4Tex -> setTexture(blimp);
            regPoly5Tex -> setTexture(blimp);
            regPoly6Tex -> setTexture(blimp);
            regPoly7Tex -> setTexture(blimp);
            regPoly8Tex -> setTexture(blimp);
            regPrism3Tex -> setTexture(blimp);
            regPrism4Tex -> setTexture(blimp);
            regPrism5Tex -> setTexture(blimp);
            regPrism6Tex -> setTexture(blimp);
            regPrism7Tex -> setTexture(blimp);
            regPrism8Tex -> setTexture(blimp);
            regPyramid3Tex -> setTexture(blimp);
            regPyramid4Tex -> setTexture(blimp);
            regPyramid5Tex -> setTexture(blimp);
            regPyramid6Tex -> setTexture(blimp);
            regPyramid7Tex -> setTexture(blimp);
            regPyramid8Tex -> setTexture(blimp);
            ...
            regPolysNode -> addChild(regPoly3Tex);
            regPolysNode -> addChild(regPoly4Tex);
            regPolysNode -> addChild(regPoly5Tex);
            regPolysNode -> addChild(regPoly6Tex);
            regPolysNode -> addChild(regPoly7Tex);
            regPolysNode -> addChild(regPoly8Tex);
            ...
            regPoly3Tex -> setTranslation(-10, 0, 0);
            regPoly4Tex -> setTranslation(-12, 0, 0);
            regPoly5Tex -> setTranslation(-14, 0, 0);
            regPoly6Tex -> setTranslation(-16, 0, 0);
            regPoly7Tex -> setTranslation(-18, 0, 0);
            regPoly8Tex -> setTranslation(-20, 0, 0);
            ...
            regPrismsNode -> addChild(regPrism3Tex);
            regPrismsNode -> addChild(regPrism4Tex);
            regPrismsNode -> addChild(regPrism5Tex);
            regPrismsNode -> addChild(regPrism6Tex);
            regPrismsNode -> addChild(regPrism7Tex);
            regPrismsNode -> addChild(regPrism8Tex);
            ...
            regPrism3Tex -> setTranslation(-10, 0, 0);
            regPrism4Tex -> setTranslation(-12, 0, 0);
            regPrism5Tex -> setTranslation(-14, 0, 0);
            regPrism6Tex -> setTranslation(-16, 0, 0);
            regPrism7Tex -> setTranslation(-18, 0, 0);
            regPrism8Tex -> setTranslation(-20, 0, 0);
            ...
            regPyramidsNode -> addChild(regPyramid3Tex);
            regPyramidsNode -> addChild(regPyramid4Tex);
            regPyramidsNode -> addChild(regPyramid5Tex);
            regPyramidsNode -> addChild(regPyramid6Tex);
            regPyramidsNode -> addChild(regPyramid7Tex);
            regPyramidsNode -> addChild(regPyramid8Tex);
            ...
            regPyramid3Tex -> setTranslation(-10, 0, 0);
            regPyramid4Tex -> setTranslation(-12, 0, 0);
            regPyramid5Tex -> setTranslation(-14, 0, 0);
            regPyramid6Tex -> setTranslation(-16, 0, 0);
            regPyramid7Tex -> setTranslation(-18, 0, 0);
            regPyramid8Tex -> setTranslation(-20, 0, 0);
